...
func TestHasPathTraversalChars(t *testing.T) {
	tests := []struct {
		...
		{"Path traversal mid path", "a/../b", true},
		{"Backslash path traversal", "..\\win32", true},
		{"Backslash traversal mid", "x\\..\\y", true},
		{"Trailing traversal segment", "x\\..", true},
		{"Just dots", "..", true},
		{"Double dot in filename", "file..txt", false},
		{"Versioned filename", "version..1.txt", false},
		{"Dotted report filename", "report..final.pdf", false},
		{"Trailing dots in name", "report..", false},
		{"Leading dots in name", "..hidden", false},
		{"Ellipsis name", "...", false},
		{"Hidden dotfile", ".gitignore", false},
		{"Multi dotted build tag", "v1.2..3.release", false},
		{"Empty string", "", false},
	}
