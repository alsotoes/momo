...
CheckMetricsAndSwap-4             8.302n ± ∞ ¹    8.262n ± ∞ ¹       ~ (p=0.151 n=5)
IndexSearch-4                     2.134n ± ∞ ¹    2.145n ± ∞ ¹       ~ (p=1.000 n=5)
IndexDirectTracking-4            0.3048n ± ∞ ¹   0.3064n ± ∞ ¹       ~ (p=0.968 n=5)
geomean                           1.754n          1.758n        +0.19%
...
xychart-beta
    ...
    x-axis [comm,3fe8,9669,0b51,1684,aa52,aad1,535a,063a]
    line "CheckMetricsAndSwap" [9,8,8,9,8,8,8,8]
    line "IndexDirectTracking" [0,0,0,0,0,0,0,0]
    line "IndexSearch" [3,2,2,2,2,2,2,2]
```
...
xychart-beta
    ...
    y-axis "Avg. Bytes/Op"
    x-axis [comm,3fe8,9669,0b51,1684,aa52,aad1,535a,063a]
    line "CheckMetricsAndSwap" [0,0,0,0,0,0,0,0]
    line "IndexDirectTracking" [0,0,0,0,0,0,0,0]
    line "IndexSearch" [0,0,0,0,0,0,0,0]
```
