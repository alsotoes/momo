...
CheckMetricsAndSwap-4             8.433n ± ∞ ¹    8.426n ± ∞ ¹       ~ (p=1.000 n=5)
IndexSearch-4                     2.193n ± ∞ ¹    2.194n ± ∞ ¹       ~ (p=0.849 n=5)
IndexDirectTracking-4            0.3120n ± ∞ ¹   0.3118n ± ∞ ¹       ~ (p=0.651 n=5)
geomean                           1.794n          1.793n        -0.03%
...
xychart-beta
    ...
    x-axis [comm,3fe8,9669,0b51,1684,aa52]
    line "CheckMetricsAndSwap" [9,8,8,9,8]
    line "IndexDirectTracking" [0,0,0,0,0]
    line "IndexSearch" [3,2,2,2,2]
```
