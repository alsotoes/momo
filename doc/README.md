...
CheckMetricsAndSwap-4             8.426n ± ∞ ¹    8.437n ± ∞ ¹       ~ (p=0.286 n=5)
IndexSearch-4                     2.189n ± ∞ ¹    2.191n ± ∞ ¹       ~ (p=0.389 n=5)
IndexDirectTracking-4            0.3125n ± ∞ ¹   0.3132n ± ∞ ¹       ~ (p=0.548 n=5)
geomean                           1.793n          1.796n        +0.15%
...
xychart-beta
    ...
    x-axis [comm,3fe8,9669,0b51,1684,aa52,aad1,535a,063a,425d]
    line "CheckMetricsAndSwap" [9,8,8,9,8,8,8,8,8]
    line "IndexDirectTracking" [0,0,0,0,0,0,0,0,0]
    line "IndexSearch" [3,2,2,2,2,2,2,2,2]
```
...
xychart-beta
    ...
    y-axis "Avg. Bytes/Op"
    x-axis [comm,3fe8,9669,0b51,1684,aa52,aad1,535a,063a,425d]
    line "CheckMetricsAndSwap" [0,0,0,0,0,0,0,0,0]
    line "IndexDirectTracking" [0,0,0,0,0,0,0,0,0]
    line "IndexSearch" [0,0,0,0,0,0,0,0,0]
```
