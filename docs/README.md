...
LoadGlobalConfig-4                545.6n ± ∞ ¹    543.5n ± ∞ ¹       ~ (p=0.421 n=5)
PadString-4                       49.62n ± ∞ ¹    50.70n ± ∞ ¹  +2.18% (p=0.032 n=5)
CheckMetricsAndSwap-4             9.169n ± ∞ ¹    9.167n ± ∞ ¹       ~ (p=0.532 n=5)
IndexSearch-4                     2.820n ± ∞ ¹    2.661n ± ∞ ¹       ~ (p=0.500 n=5)
IndexDirectTracking-4            0.3530n ± ∞ ¹   0.3529n ± ∞ ¹       ~ (p=1.000 n=5)
geomean                           11.98n          11.89n        -0.81%
...
| BenchmarkLoadGlobalConfig-4 | 546.46 ns/op | 480.00 B/op | 2.00 allocs/op |
| BenchmarkPadString-4 | 50.67 ns/op | 128.00 B/op | 2.00 allocs/op |
...
xychart-beta
    ...
    x-axis [0eaa,e6e8,3601,8c97,9623,6797,3b5e,4501]
    ...
    line "PadString" [50,50,50,53,53,50,53,53,53,51]
