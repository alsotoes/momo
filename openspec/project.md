...
20. **Autonomous Traceability:** The Gemini AI Reviewer is authorized to autonomously resolve Rule 11 (Traceability) violations. If a Pull Request lacks a corresponding GitHub Issue, the Reviewer MUST create a tracking issue and link it to the PR before proceeding with the audit.